...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'Mathieu_Vandernoot_20221208_treetravel_672bf3b0a326b0143306_20221208153134_archive.zip';
        const ARCHIVE_SIZE       = '40044456';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '672bf3b-08153134';
        const SECONDARY_PACKAGE_HASH = 'c684df0-08153134';
        const VERSION            = '1.5.1';
